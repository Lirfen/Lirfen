...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/DSTORTEAM/Files_DSTOR/master/File_Bot/commands.lua") 
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local DSTOR1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..DSTOR1.server.uptime_in_days..'('..DSTOR1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..DSTOR1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..DSTOR1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..DSTOR1.stats.instantaneous_ops_per_sec..'`\n'
...
os.execute('wget https://raw.githubusercontent.com/DSTORTEAM/DSTOR/master/DSTOR.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس دستور\n📡| الاصدار ← { 1.2v}')
dofile('DSTOR.lua')  
end
if text == 'الاصدار 📟' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'📡| اصدار سورس دستور \n📟| الاصدار ←{ 1.2v}') 
end
...
--------------------------------------------------------------------------------------------------------------
if DSTOR_Msg and not Special(msg) then  
...
🔖↬DSTOR TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📮↬[Channel DSTOR](t.me/HH4HHHH) 

🔰↬[Information](t.me/HH4HHHH)

👮‍♂️↬[DEVELOPER](t.me/VCVVVV)

👮‍♂️↬[DEVELOPER](t.me/HH4HHHH)

🔖↬[The way his inauguration](https://t.me/hh4hhhh/15)

📌↬[To talk to us](t.me/vcvvvv)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/DSTORTEAM/Files_DSTOR/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات دستور\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/DSTORTEAM/Files_DSTOR/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DSTOR.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس دستور\n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'دستور').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'دستور')
local DSTOR_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'دستور').." غادر" or text == 'غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'دستور')
